...
import course.entity.ChapterResource;
import course.entity.Course;
import course.entity.Resource;
import course.mapper.ChapterMapper;
import course.mapper.ChapterResourceMapper;
import course.mapper.CourseMapper;
import course.mapper.ResourceMapper;
...
public class CourseServiceImpl implements CourseService {
    ...
    private Map<Integer, String> getAssistantNames(List<Integer> assistantIds) {
        ...
        return userMapper.selectBatchIds(assistantIds).stream()
                .collect(Collectors.toMap(org.example.teacherservice.entity.User::getUserId, org.example.teacherservice.entity.User::getRealName));
    }
