...
public class ResourcesServiceImpl extends ServiceImpl<ResourcesMapper, Resources>
    ...
    @Override
    public boolean delResourceById(Integer resourceId) throws ServerException, InsufficientDataException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException {
