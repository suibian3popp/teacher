...
import org.example.teacherservice.configs.MinIOInfo;
...
//                             @RequestParam("name") String name,
                             ...
                             @RequestParam("permission") String permission) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException, io.minio.errors.ServerException, io.minio.errors.InternalException {
...
//    }
    ...
    public void downloadResource(@PathVariable(value="resourceId") Integer resourceId, HttpServletResponse response) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException, io.minio.errors.ServerException, io.minio.errors.InternalException {
...
//        response.setHeader("Content-disposition", "attachment;filename=" + URLEncoder.encode(object, StandardCharsets.UTF_8));
    ...
    public R previewResource(@PathVariable("resourceId") Integer resourceId) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException, io.minio.errors.ServerException, io.minio.errors.InternalException {
        //获取资源信息
        Resources resource = resourcesService.getById(resourceId);
